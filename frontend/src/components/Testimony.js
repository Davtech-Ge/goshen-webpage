  ...
  return (
    <div className='w-full h-4/5 bg-black p-4'>
        ...
        <img src='/images/externalminis.jpg' alt='testimonies' className='w-full h-45 object-cover relative' />
               ...
               <h1 className='text-sm text-gray-200'>TESTIMONIES</h1>
               <h1 className='text-sm text-gray-200'>(FAITH STORIES)</h1>
               <p className='text-xs text-gray-200'>We welcome testimonies from our online viewers connecting across the world. please share your testimonies with us via:</p>
