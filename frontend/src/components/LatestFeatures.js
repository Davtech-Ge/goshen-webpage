  ...
  return (
    <section className='bg-black text-white py-4 px-4'>
        <div className='max-w-5xl mx-auto'>
            ...
            <div className='lg:absolute lg:top-0 lg:left-2 grid lg:grid-cols-1 grid-cols-3 gap-4 text-center'>
                ...
                <button onClick={() => handleClick(3)} className='bg-gray-800 lg:py-4 py-2 lg:px-4 px-3 rounded'>
                    <div className='text-2xl mb-2'><FontAwesomeIcon icon='fa-solid fa-up-from-line' /></div>
...
const MessageIcon = ({picture, pTag, HTag, Buttontag}) => {
    return (
        <div className='lg:relative rounded-lg overflow-hidden w-full h-3/4 lg:h-screen shadow-lg mb-6'>
